...
<body>
    <div id="wrapper">
        ...
        <form action="" id="myform">
            ...
            <div id="form_gender">
                Gender :<br><br>
                <input id="gender_male" type="radio" name="gender_male" value="Male">Male<br><br>
                <input id="gender_female" type="radio" name="gender_female" value="Female">Female<br>
            </div>
            ...
            <br>
            <a id="link_login" href="login.php">
